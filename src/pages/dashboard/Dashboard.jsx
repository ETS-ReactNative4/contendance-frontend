            ...
            <Col xs={6} sm={6} xl={3}>
              <Widget className="widget-p-sm">
                <div className={s.smallWidget}>
                  ...
                  >
                    <i className="eva eva-cast"></i>
                  </div>
                  <div className="d-flex flex-column">
                    <p className="headline-3">Beacon</p>
                    <p className="body-2">
                      2<span className="body-3 muted"> Alat</span>
                    </p>
                  </div>
                </div>
              </Widget>
            ...
            <Col xs={6} sm={6} xl={3}>
              <Widget className="widget-p-sm">
                <div className={s.smallWidget}>
                  ...
                  >
                    <i className="eva eva-people-outline"></i>
                  </div>
                  <div className="d-flex flex-column">
                    <p className="headline-3">Pengguna</p>
                    <p className="body-2">
                      10<span className="body-3 muted"> Akun</span>
                    </p>
                  </div>
                </div>
              </Widget>
            ...
            <Col xs={6} sm={6} xl={3}>
              <Widget className="widget-p-sm">
                <div className={s.smallWidget}>
                  ...
                  >
                    <i className="eva eva-grid-outline"></i>
                  </div>
                  <div className="d-flex flex-column">
                    <p className="headline-3">Ruangan</p>
                    <p className="body-2">
                      5<span className="body-3 muted"> Kelas/Lab/Hall</span>
                    </p>
                  </div>
                </div>
              </Widget>
            ...
            <Col xs={6} sm={6} xl={3}>
              <Widget className="widget-p-sm">
                <div className={s.smallWidget}>
                  ...
                  <div className="d-flex flex-column">
                    <p className="headline-3">Perangkat</p>
                    <p className="body-2">
                      7<span className="body-3 muted"> Terdaftar</span>
                    </p>
                  </div>
                </div>
              </Widget>
